...
package com.example.demo.subscriptionbackgroundflow.repository
...
import com.example.demo.subscriptionbackgroundflow.data.ContentResource
    ...
    fun updateSubscriptionsFromNetwork(remoteSubscriptions: List<SubscriptionStatus>?) {
        ...
        remoteSubscriptions?.let {
            ...
            if (updateBasic) {
                ...
                Log.d(TAG, "updateSubscriptionsFromNetwork: updateBasic")
            ...
            if (updatePremium) {
                ...
                Log.d(TAG, "updateSubscriptionsFromNetwork: updatePremium")
    ...
    companion object {
        ...
        fun getInstance(
                ...
                INSTANCE ?: synchronized(this) {
                    INSTANCE ?:
                    DataRepository(localDataSource, billingClientLifecycle)
                            .also { INSTANCE = it }
                }
    }
